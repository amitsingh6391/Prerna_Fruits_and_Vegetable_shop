...
//            physics: NeverScrollableScrollPhysics(),
      ...
      bottomNavigationBar:Container(color: x,
        height: 60,
        child: TabBar(
          onTap: (index) {
            if (index == 0) {
          ...
          tabs: <Widget>[
            ...
            Tab(
              icon: Icon(Icons.widgets_rounded,size:20,),
              child: Text("Category",style: TextStyle(fontSize: 12),maxLines: 1,),
            ),
            Tab(
              icon: Icon(Icons.favorite_rounded,size:20,),
              child: Text("Favourite",style: TextStyle(fontSize: 12),maxLines: 1,),
            ),
            Tab(
              icon: Icon(Icons.shopping_bag_rounded,size: 20,),
              child: Text("Cart",style: TextStyle(fontSize: 12),maxLines: 1,),
            ),
          ],
          controller: tabController,
        ),
