...
class _cartState extends State<cart> {
  ...
  cartitemremove(var itemid, var qty) async {
    String apiUrl =
        "http://pfv.wonsoft.co.in/API/Post.asmx/CartRem?UID=$userid&itemID=$itemid&itemQty=$qty";
    print("apiUrl***********88");
    print(apiUrl);
    http.Response response = await http.get((Uri.parse(apiUrl)));
...
//confirmation dialog...
  ...
  checkout(var total) async {
    String apiUrl =
        "http://pfv.wonsoft.co.in/API/Post.asmx/CheckOut?UID=$userid&OrderTot=$total";
    ...
    if (response.statusCode == 200) {
      ...
      Fluttertoast.showToast(
        msg:
            "Your Order No ${oredrstatus![0]["OrderNo"]} is Successfully Placed.",
        fontSize: 15,
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => FirstTab()));
    } else {
      oredrstatus = [];
      print("345");
    }
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: Container(
            ...
            color: Colors.white,
            height: 120,
            child: numberodproduct!.length == 0
                ? Text("")
                : Column(
                    ...
                    children: <Widget>[
                      ...
                      GestureDetector(
                          onTap: () {
                            showAlertDialog(
                                context, numberodproduct!.last["Total"]);
                          ...
                          child: Container(
                              ...
                              child: Row(children: [
                                Center(
                                    child: Text(
                                        "  Total ${numberodproduct!.last["TotQty"]} item(s)  ₹ ${numberodproduct!.last["Total"]} ",
                                        style: TextStyle(
                                            fontSize: 17,
                                    ...
                                    children: [
                                      ...
                                      Row(children: [
                                        ...
                                        Container(
                                            margin: EdgeInsets.only(right: 0),
                                            child: Text(
                                              "       ₹ ${numberodproduct![index]["MRP"].toString()}",
                                              style: TextStyle(
                                                  color: Colors.black,
                                                  fontWeight: FontWeight.bold),
                                            )),
